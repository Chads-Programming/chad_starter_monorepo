...
export class Migration20240807022523 extends Migration {
  ...
  async up(): Promise<void> {
    ...
    this.addSql('create table "user" ("id" uuid not null, "created_at" timestamptz not null, "updated_at" timestamptz not null, "first_name" varchar(255) not null, "last_name" varchar(255) not null, "email" varchar(255) not null, "is_active" boolean not null default true, constraint "user_pkey" primary key ("id"));');
